...
5Verify the sitemap: Finally, verify that Google can access your XML sitemap by entering the full URL of the sitemap in the Google Search Console Sitemaps report. If Google can access the sitemap, it will appear as "Submitted" in the report.
