...
Create an XML sitemap: If you haven't already, create an XML sitemap for your website. There are many online tools available to help you generate an XML sitemap, or you can use a plugin if you're using a CMS like WordPress.

Upload your XML sitemap to your website: Once you have your XML sitemap, upload it to the root directory of your website. This is typically done using an FTP client or your website's control panel.

Add the reference to your XML sitemap in the robots.txt file: Open your website's robots.txt file and add the following line to it:
...
Save and upload the updated robots.txt file: Save your changes to the robots.txt file and upload it to the root directory of your website. Make sure the file name is "robots.txt" and that it is located in the root directory.
