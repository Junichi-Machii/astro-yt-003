...
Use a Content Management System (CMS) Plugin: If you are using a CMS like WordPress, you can install a plugin that generates an XML sitemap for you. For example, the Yoast SEO plugin creates a sitemap that is automatically updated whenever you add or remove pages from your site.
