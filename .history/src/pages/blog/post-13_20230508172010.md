...
1Sign in to your Google Search Console account.

Select your website from the list of properties. If you haven't already added your website to Search Console, you'll need to do so by following the on-screen instructions.

In the left-hand menu, click on "Sitemaps."

Click on the "Add/Test Sitemap" button located at the top-right corner of the page.

Enter the URL of your sitemap in the text box that appears, for example, "https://www.example.com/sitemap.xml".
